...
const PricingHero = () => {
  return (
    <section className="padding-x pt-11.5 pb-[72px]">
        {/* Hero */}
        <div className="relative px-6 md:px-11 py-[92px] md:py-20.5 rounded-lg overflow-hidden text-white">
          <h1 className="relative z-10 text-2xl md:text-[48px] font-extrabold leading-8 md:leading-14 max-w-[449px]">
            Live Shipping Rates <br className="sm:hidden" /> at Your Fingertips
          </h1>
          <p className="relative z-10 mt-3 md:mt-6 text-sm md:text-lg leading-5.5 md:leading-7">
