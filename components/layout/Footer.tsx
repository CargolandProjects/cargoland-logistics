      ...
      <section className="bg-[#0B112B] text-white pt-20 pb-10 px-6 md:px-32">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pb-12 text-[#878FA4] text-[13px] leading-relaxed">
            <p>
              <strong>Address 1:-</strong> 303B Sahco Business Complex Cargo
              Terminal MMIA (Muritala Muhamemed International Airport) Lagos
              Nigeria (HQ)
            </p>
            <p>
              <strong>Address 2:-</strong> Warehouse Office 185 Akowonjo Road
          ...
          <div className="pt-10 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6">
            <p className="text-[#878FA4] text-[14px]">
              © 2026 Cargoland Africa. All rights reserved.
            </p>
            ...
            <div className="flex gap-4">
              {[1, 2, 3, 4].map((i) => (
                <div
                  key={i}
                  className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-white hover:bg-white hover:text-[#0B112B] transition-all cursor-pointer"
                >
