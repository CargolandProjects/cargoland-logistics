...
export default function MyShipmentPageContent({
  ...
  const handleView = (e: MouseEvent, id: string) => {
    e.stopPropagation();
    if (mode === "USER") handleRoute(`/my-shipment/${id}`);
    if (mode === "B2B") handleRoute(`/b2b/my-shipment/${id}`);
  };
  ...
  return (
    <div>
      ...
      {/* Dashboard Stats */}
      <section className="mt-5 md:mt-6 grid grid-cols-2 md:grid-cols-4 gap-3 lg:gap-6 ">
        ...
        <div className="flex max-md:flex-col-reverse gap-4 md:justify-between">
          ...
          <div className="relative w-full md:max-w-[291px]">
            <Input
              ...
              className="form-input h-12.5! pl-10! placeholder:text-slate-600/90!"
            />
